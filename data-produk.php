                ...
                <table border="1" cellspacing= "0" class="tabel">
                    ...
                    <tbody>
                            <?php
                                ...
                                $produk = mysqli_query($conn, "SELECT * FROM tb_product LEFT JOIN tb_kategory USING (kategory_id) 
                                ORDER By product_id DESC");

                                if(mysqli_num_rows($produk) > 0){ //jika data produk kosong/lebih dari nol
                        ...
                        <tr>
                            ...
                            <!--tag a : untuk menampilkan gambar ketika di klik-->
                            <!--tag target : untuk menampilkan gambar di tab baru ketika di klik-->
                        ...
                        <?php }}else{ ?> <!--//maka tamppilkan tidak ada produk-->
                               <tr>
